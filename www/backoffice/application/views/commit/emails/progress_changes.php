...
<head>
    ...
    <title>Changes required before closing commitment</title>
</head>

<body>
<p>Sorry!</p>
<p>More updates are required before your commitment "<?php echo $commitment->proposal_title ?>" can be published</p>
<?php
