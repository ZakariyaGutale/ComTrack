...
<head>
    ...
    <title>Commitment approved for publication</title>
</head>

<body>
<p>Congratulations!</p>
<p>Your commitment "<?php echo $commitment->proposal_title ?>" has been approved for publication.</p>
<?php
...
<p>Normally, new commitments only become visible on the Map after they have been made official during the Conference event.</p>
<p>Contact us if you need any further information.</p>
