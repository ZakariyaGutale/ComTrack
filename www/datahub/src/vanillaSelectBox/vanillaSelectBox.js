...
function vanillaSelectBox(domSelector, options) {
    ...
    this.repositionMenu = function(){
        ...
        //this.drop.style.top = (rect.bottom - this.userOptions.maxHeight - 38)+"px";

        this.drop.style.left = self.main.offsetLeft+"px";
        this.drop.style.bottom = (self.main.offsetHeight - 9) + 'px';
		...
		if(self.userOptions.stayOpen){
			...
			this.main.addEventListener("click", function (e) {
				if (self.isDisabled) return;
                    ...
                    self.drop.style.left = self.main.offsetLeft+ "px";
                    self.drop.style.bottom = (self.main.offsetHeight - 9) + "px";
                    self.drop.style.display = "block";
